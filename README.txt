...
Requests and cryptography may need to be installed via pip. To do this, run 
"pip install requests cryptography" or "python -m pip install requests cryptography"
